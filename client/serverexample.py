...
class NetworkServer:
    ...
    def handle_client(self, conn, addr):
        ...
        try:
            ...
            # register client only after checking name
            with self.lock:
            ...
            while True:
                ...
                if cmd == "MSG":
                    ...
                    # TO target message
                    # split rest again into target + message
                    if len(parts) == 2:
    ...
    def broadcast(self, msg: str):
        # iterate over a static list to avoid runtime change while iterating
        with self.lock:
